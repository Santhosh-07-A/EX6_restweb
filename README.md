...
<body>
    ...
    <section class="menu" id="menu">
        ...
        <div class="menu-cards">
            ...
            <div class="card">
                <img src="desert.jpg" alt="Dish">
                <h3>Chocolate Dessert</h3>
                <p>Soft & rich chocolate delight</p>
                <span>₹150</span>
            </div>
            <div class="card">
                <img src="biriyani.jpg" alt="Dish">
...
![alt text](<Screenshot (25).png>) ![alt text](<Screenshot (26).png>)
## RESULT:
